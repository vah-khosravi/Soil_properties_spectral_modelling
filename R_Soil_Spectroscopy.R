...
path <- "C:/Users/uzivatel/OneDrive - CZU v Praze/Personal/iPhD/Data/exdata"

soil_data <- read_csv(file.path(path, "All_Lab.csv"))
# soil_data <- read_excel(file.path(path, "WW_Belgium_Wet_Spectra_cor.xlsx"))
